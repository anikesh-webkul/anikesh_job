...
<div id="blockDes">
            ...
            <p id="jobTitle"><?php echo e($job_id->title); ?></p>
            ...
            <p id="exp_from"><?php echo e($job_id->ex_from); ?>&nbsp&nbspto</p>
            <p id="exp_to"><?php echo e($job_id->ex_to); ?></p>
            <h3 id="openLabel">Openings</h3>
            <p id="opening"><?php echo e($job_id->opening); ?></p>
            <h3 id="ctcLable">CTC</h3>
            <p id="ctc"><?php echo e($job_id->ctc); ?></p><br><br><br>
            ...
            <a id="applynow" href="../apply/<?php echo e($job_id->id); ?>">Apply Now</a><br><br><br>

        </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\Job\resources\views/job_des.blade.php ENDPATH**/ ?>